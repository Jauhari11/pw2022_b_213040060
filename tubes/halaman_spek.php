...
$edit = query2("SELECT * from tb_user");
...
//print_r($data);
//echo "ini adalah = " . $gambar_profile;
?>
...
<head>
  ...
  <link rel="stylesheet" href="./assets/dist/css/bootstrap1.min.css">
...
<body>
  ...
  <?php if ($login == false) : ?>
    ...
    <div class="container">
      <h1 class="mt-3">Daftar TechNoLogic</h1>
          ...
          <tbody>
            ...
            foreach ($mahasiswa as $m) : ?>
              <tr class="align-middle">
                <th scope="row"><?= $no++; ?></th>
                <td><img src="./inventory/<?= $m["inventory"]; ?>" width="50px" class="rounded-circle"></td>
                <td><?= $m["nama"]; ?></td>
                <td><?= $m["kode_barang"]; ?></td>
                <td><?= $m["spesifikasi"]; ?></td>
                <td><?= $m["harga"]; ?></td>
                <td>
                  ...
                  <a href="./preview.php?id=<?= $m['id']; ?>" class="btn badge bg-dark">Preview</a>
                </td>
              </tr>`
            <?php endforeach ?>
          </tbody>
    ...
    ?>
          ...
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="dropdown text-end">
              ...
              <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                ...
                <li><a class="dropdown-item" href="./edit_profile.php?id=">Edit</a></li>
                <li>
      ...
      <div class="container">
        ...
        <a href="tambah.php" class="btn btn-dark">Tambah Data TechNoLogic</a>
