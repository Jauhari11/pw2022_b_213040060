...
$id2 = $_GET["id"];
$mhs2 = query("SELECT * FROM mahasiswa WHERE id = $id2")[0];
              ...
              <div class="col-md-7">
                <div class="contact-wrap w-100 p-md-5 p-4">
                  ...
                  <form method="POST" id="contactForm" name="contactForm" class="contactForm">
                    <input type="hidden" name="id" value="<?= $mhs2["id"]; ?>">
                    <input type="hidden" class="form-control" name="email" id="email" placeholder="Email" value="<?= $mhs2["kode_barang"]; ?>">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="label" for="name">Name</label>
                          <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?= $mhs2["nama"]; ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="subject">Harga</label>
                          <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" value="<?= $mhs2["harga"]; ?>">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <textarea class="form-control" name="spesifikasi" placeholder="Spek" id="spesifikasi  " style="height: 100px"> <?= $mhs2["spesifikasi"]; ?>"</textarea>
